...
const BODY_PARAGRAPHS = [
  "Grew up in Toronto, 3rd year Math at the University of Waterloo. Four co-op terms in, mostly on the AI side now, and enjoying the fact that nobody actually knows what this field looks like in five years.",
